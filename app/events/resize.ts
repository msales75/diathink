...
$(window).resize(function() {
    ...
    if (! ($D.ready===1)) {return;} // don't resize before page is rendered
    if ($D.router.dragMode===2) {return;} // don't resize when dragging
    ...
    */
    ...
    ActionManager.schedule(function() {
        ...
        if (newCols>oldCols) { // if adding columns, we might need to change leftPanel, requiring a slide (fill-from-left)
            ...
            if (i<newCols) { // we ran out of panels
