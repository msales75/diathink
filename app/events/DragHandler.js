...
var DragHandler = (function () {
    ...
    */
    ...
    DragHandler.prototype.validatePanelDropBox = function (panel, type) {
        if (type === 'right') {
            return true;
        } else if (type === 'left') {
    ...
    DragHandler.prototype.validateNodeDropBox = function (node, type) {
        ...
        var prevElement = node.elem.previousSibling;
