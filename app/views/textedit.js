...
var TextEditView = (function (_super) {
    ...
    TextEditView.prototype.render = function () {
        this.html = '';
        ...
        if (this.hasMultipleLines) {
            this.html += '<textarea cols="40" rows="1" name="' + (this.name ? this.name : this.id) + '" id="' + this.id + '"' + this.style() + placeholder + '>' + (this.value ? this.value : '') + '</textarea>';
        } else {
    ...
    TextEditView.prototype.blur = function () {
    ...
    TextEditView.prototype.style = function () {
        var html = ' style="';
        html += '"';
    ...
    TextEditView.prototype.fixHeight = function () {
        var thisel = $('#' + this.id);
    ...
    TextEditView.prototype.theme = function (elem) {
    ...
    TextEditView.prototype.themeUpdate = function () {
        this.fixHeight();
    };
    TextEditView.prototype.styleUpdate = function () {
    ...
    TextEditView.prototype.setValueFromDOM = function () {
