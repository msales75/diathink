...
class scrollview {
    ...
    private _timerID;
    private _timerCB;
    private _$hScrollBar;
    private _$vScrollBar;
    private _$clickEle;
    private _lastX;
    private _lastY;
    private _doSnapBackX;
    private _doSnapBackY;
    private _speedX;
    private _speedY;
    private _directionLock;
    private _didDrag;
    private _maxX;
    private _maxY;
    private _pageDelta;
    ...
    private _startMScroll(speedX:number, speedY:number) {
        this._stopMScroll();
    ...
    private _setScrollPosition(x:number, y:number) {
        this._sx = x;
        this._sy = y;
    ...
    public scrollTo(x:number, y:number, duration) {
        this._stopMScroll();
        if (!duration) {
            this._setScrollPosition(x, y);
            return;
...
class MomentumTracker {
    ...
    start(pos, speed, duration, minPos, maxPos) {
