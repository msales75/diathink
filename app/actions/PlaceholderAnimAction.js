...
var PlaceholderAnimAction = (function (_super) {
    ...
    PlaceholderAnimAction.prototype.linePlaceAnim = function (outline) {
        ...
        if (r.useLinePlaceholderAnim[outline.nodeRootView.id]) {
            ...
            if (this.options.anim === 'delete') {
                speed = this.deleteSpeed;
            } else if (this.options.anim === 'create') {
    ...
    PlaceholderAnimAction.prototype.oldLinePlaceAnimStep = function (frac, o) {
        ...
        $(this.runtime.rOldLinePlaceholder[rootID]).css('height', String(Math.round(startOldHeight * (1 - frac))) + 'px');
    };

    PlaceholderAnimAction.prototype.newLinePlaceAnimStep = function (frac, o) {
        var endNewHeight = o.endNewHeight, sameHeight = o.sameHeight, rootID = o.rootID, startOldHeight = o.startOldHeight;
        if ((this.oldType === 'line') && sameHeight) {
            $(this.runtime.rNewLinePlaceholder[rootID]).css('height', String(startOldHeight - Math.round(startOldHeight * (1 - frac))) + 'px');
        } else {
